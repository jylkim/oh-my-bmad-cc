---
name: omb-domain-research-parallel
description: 'Parallelized version of bmad-domain-research that uses an Agent Team for concurrent research steps. Steps 2-5 run in parallel with 4 specialist agents, with follow-up deep-dives available before user approval. Use when the user says "parallel domain research", "fast domain research", "parallel research", or wants to speed up domain research.'
---

<steps CRITICAL="TRUE">

1. Read `{project-root}/.claude/skills/bmad-domain-research/SKILL.md` and follow its instructions EXACTLY
2. Follow the workflow through CONFIGURATION, QUICK TOPIC DISCOVERY, and ROUTE TO DOMAIN RESEARCH STEPS — execute step 1 (scope confirmation) as normal
...
- output_file: {resolved path to the research document created in ROUTE TO DOMAIN RESEARCH STEPS}
- steps_path: {project-root}/_bmad/bmm/1-analysis/research/bmad-domain-research/domain-steps
