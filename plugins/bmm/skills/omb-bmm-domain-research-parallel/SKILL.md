---
name: omb-bmm-domain-research-parallel
description: 'Parallelized version of bmad-bmm-domain-research that uses an Agent Team for concurrent research steps. Steps 2-5 run in parallel with 4 specialist agents, with follow-up deep-dives available before user approval. Use when the user says "parallel domain research", "fast domain research", "parallel research", or wants to speed up domain research.'
---

<steps CRITICAL="TRUE">

1. Read `{project-root}/.claude/commands/bmad-bmm-domain-research.md` and follow its instructions EXACTLY
...
- steps_path: {project-root}/_bmad/bmm/workflows/1-analysis/research/domain-steps
