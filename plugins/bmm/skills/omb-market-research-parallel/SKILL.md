---
name: omb-market-research-parallel
description: 'Parallelized version of bmad-market-research that uses an Agent Team for concurrent research steps. Steps 2-5 run in parallel with 4 specialist agents, with follow-up deep-dives available before user approval. Use when the user says "parallel market research", "fast market research", "parallel research", or wants to speed up market research.'
---

<steps CRITICAL="TRUE">

1. Read `{project-root}/.claude/skills/bmad-market-research/SKILL.md` and follow its instructions EXACTLY
...
- steps_path: {project-root}/_bmad/bmm/1-analysis/research/bmad-market-research/steps
