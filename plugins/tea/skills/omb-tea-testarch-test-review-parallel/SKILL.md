...
description: 'Parallel pipeline execution of bmad-testarch-test-review. Use when the user says "parallel test review", "fast test review", "parallel quality review", or wants to speed up test quality evaluation.'
---

<steps CRITICAL="TRUE">

1. Read `{project-root}/.claude/skills/bmad-testarch-test-review/SKILL.md` and follow its instructions EXACTLY
